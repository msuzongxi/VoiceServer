...
_emb_root = "/home/wsuser/projects/voice/embeddings/"
...
if __name__== "__main__":
    ...
    total_subject_similarity = np.dot(df_voice_emb.iloc[:, 1:].values, subject_emb)
    ...
    for song_id in tbp_songs:
        ...
        df_song_id_ratings_similarity = pd.merge(df_song_id_ratings, df_similarity,
                                             on=['uid'], how='inner')
        df_knn_ratings = df_song_id_ratings_similarity.sort_values(by=['similarity'], ascending=False).iloc[:_k, ]
